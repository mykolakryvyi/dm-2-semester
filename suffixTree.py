...
class Node:
    ...
    def __eq__(self, node):
        return self.start == node.start and self.end == node.end and self.suffixIndex == node.suffixIndex
    ...
    def __str__(self):
        return str(self.start)+', '+str(self.end)+', '+str(self.suffixIndex)
...
if __name__ == "__main__":
    ...
    for key in new_tree.root.children:
        print(key, new_tree.root.children[key])
