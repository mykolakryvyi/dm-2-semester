...
#         return str(Autocompleter(trie).sorted_autocomplete('hell'))

#     return render_template('index.html', words = str(Autocompleter(start_completing()).sorted_autocomplete('hell')))
def plot_ngram():
    '''
